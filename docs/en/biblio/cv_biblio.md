...
1. **Elgrishi, N. et al.**
   *"A Practical Beginner's Guide to Cyclic Voltammetry."*
   ...
   - [Direct PDF (IIT Kanpur)](https://www.iitk.ac.in/che/PG_research_lab/pdf/resources/MVA-reading-material.pdf)
   - [ResearchGate](https://www.researchgate.net/publication/320843983)
   - Modern comprehensive guide, recommended for beginners.

2. **Kissinger, P. T.; Heineman, W. R.**
   *"Cyclic Voltammetry."*
   J. Chem. Educ. **1983**, 60, 702-706.
   - [Direct PDF (Colorado State)](https://diverdi.colostate.edu/C431/experiments/electrochemistry%20-%20cyclic%20voltammetry/references/j_chem_ed_1983_v60_p702.pdf)
   - Classic reference article, highly cited.
...
4. **MIT OpenCourseWare**
   *"Lecture 13: Butler-Volmer equation."*
   Course 10.626 - Electrochemical Energy Systems.
...
| **EchemFEM** | Electrochemistry Firedrake | [GitHub](https://github.com/LLNL/echemfem) |
| **FEniCSx** | FEM Open-source | [fenicsproject.org](https://fenicsproject.org/) |
| **OpenFOAM** | FVM Open-source | [openfoam.com](https://www.openfoam.com/) |
| **GMSH** | Meshing | [gmsh.info](https://gmsh.info/) |
